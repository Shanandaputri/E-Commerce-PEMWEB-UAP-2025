        ...
        <div class="flex">
            ...
            <main class="ml-64 flex-1 overflow-y-auto">
                <div class="max-w-6xl mx-auto px-8 py-8">
                    ...
                    <div class="mb-6">
                        <h1 class="text-2xl font-semibold text-gray-900">Manajemen User &amp; Store</h1>
                        <p class="text-sm text-gray-500 mt-1">
                            Kelola role user dan informasi toko.
                        </p>
                    </div>
                                        ...
                                        <tr class="border-b">
                                            ...
                                            <td class="px-3 py-2">
                                                <form method="POST"
                                                    ...
                                                    <button class="px-2 py-1 bg-gray-800 text-white text-xs rounded">
                                                        Update
                                                    </button>
                                                </form>
                                            </td>
                                            ...
                                            <td class="px-3 py-2">
                                                @if ($user->store)
                                                    ...
                                                    @if ($user->store->is_verified)
                                                        <span class="ml-2 px-2 py-1 text-xs rounded bg-green-100 text-green-700">
                                                            Verified
                                                        </span>
                                                    @else
                                                        <span class="ml-2 px-2 py-1 text-xs rounded bg-yellow-100 text-yellow-700">
                                                            Pending
                                                        </span>
                                                    @endif
                                                @else
                                                    <span class="text-gray-500 text-xs">Tidak punya toko</span>
                                                @endif
                                            </td>
                                            ...
                                            <td class="px-3 py-2">
                                                ...
                                                @else
                                                    <span class="text-xs text-gray-400">Ini kamu sendiri</span>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
